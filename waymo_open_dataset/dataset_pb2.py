...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='waymo_open_dataset/dataset.proto',
...
_CONTEXT_STATS_OBJECTCOUNT.fields_by_name['type'].enum_type = waymo__open__dataset_dot_label__pb2._LABEL_TYPE
...
_CAMERALABELS.fields_by_name['labels'].message_type = waymo__open__dataset_dot_label__pb2._LABEL
...
_FRAME.fields_by_name['laser_labels'].message_type = waymo__open__dataset_dot_label__pb2._LABEL
...
_FRAME.fields_by_name['no_label_zones'].message_type = waymo__open__dataset_dot_label__pb2._POLYGON2DPROTO
...
MatrixShape = _reflection.GeneratedProtocolMessageType('MatrixShape', (_message.Message,), dict(
  ...
  __module__ = 'waymo_open_dataset.dataset_pb2'
...
_MATRIXFLOAT.fields_by_name['data']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001'))
_MATRIXINT32.fields_by_name['data'].has_options = True
_MATRIXINT32.fields_by_name['data']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001'))
_RANGEIMAGE.fields_by_name['range_image'].has_options = True
_RANGEIMAGE.fields_by_name['range_image']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\030\001'))
